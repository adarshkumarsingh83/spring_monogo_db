...
import com.adarsh.mongo.config.MongoConfigFactoryTwo;
 ...
 */
public class AnnotationConfigTestTwo {

    private static final ApplicationContext APPLICATION_CONTEXT = new AnnotationConfigApplicationContext(MongoConfigFactoryTwo.class);
