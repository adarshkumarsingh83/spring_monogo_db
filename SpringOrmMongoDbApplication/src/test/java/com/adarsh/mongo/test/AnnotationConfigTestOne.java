...
import com.adarsh.mongo.config.MongoConfigFactoryOne;
 ...
 */
public class AnnotationConfigTestOne {

    private static final ApplicationContext APPLICATION_CONTEXT = new AnnotationConfigApplicationContext(MongoConfigFactoryOne.class);
